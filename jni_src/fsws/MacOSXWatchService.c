...
Java_us_hall_trz_osx_MacOSXWatchService_initIDs(JNIEnv* env, __unused jclass clazz)
{
...
traceLine(JNIEnv* env, const char* fmt, ...)
{
    if (tracingEnabled) {
        ...
        JNU_CallStaticMethodByName(env, &ignoreException, "us/hall/trz/osx/MacOSXWatchService", "traceLine", "(Ljava/lang/String;)V", text);
    }
}
...
Java_us_hall_trz_osx_MacOSXWatchService_eventStreamCreate(JNIEnv* env, __unused jclass clazz,
 ...
 */
JNIEXPORT void JNICALL
Java_us_hall_trz_osx_MacOSXWatchService_eventStreamSchedule(__unused JNIEnv* env,  __unused jclass clazz,
 ...
 */
JNIEXPORT void JNICALL
Java_us_hall_trz_osx_MacOSXWatchService_eventStreamStop(__unused JNIEnv* env, __unused jclass clazz, jlong eventStreamRef)
{
 ...
 */
JNIEXPORT jlong JNICALL
Java_us_hall_trz_osx_MacOSXWatchService_CFRunLoopGetCurrent(__unused JNIEnv* env, __unused jclass clazz)
{
 ...
 */
JNIEXPORT void JNICALL
Java_us_hall_trz_osx_MacOSXWatchService_CFRunLoopRun(__unused JNIEnv* env, __unused jclass clazz, jlong watchServiceObject)
{
...
JNIEXPORT void JNICALL
Java_us_hall_trz_osx_MacOSXWatchService_CFRunLoopStop(__unused JNIEnv* env, __unused jclass clazz, jlong runLoopRef)
{
